package kr.airport.parking.util.gpki;
...
public class NewGpkiUtil {
	...
	private static Logger logger = LoggerFactory.getLogger(NewGpkiUtil.class);
	...
	public void init() throws Exception {
		...
		logger.info("Loading gpki certificate : myServerId="+ this.getMyServerId());
...
//			String ldapUrl = "ldap://10.1.7.118:389/cn=";
			...
			if(certFilePath != null){
				...
				logger.debug("Loading gpki certificate 완료 : targetServerId="
						+ certId);
			} else {
